namespace Ark.Entities.BO
{
    ...
    public partial class BlockchainTxBO
    {
        public static BlockchainTxBO FromJson(string json) => JsonConvert.DeserializeObject<BlockchainTxBO>(json, Ark.Entities.BO.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this BlockchainTxBO self) => JsonConvert.SerializeObject(self, Ark.Entities.BO.Converter.Settings);
    }
