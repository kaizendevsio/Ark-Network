...
namespace Ark.ExternalUtilities.Models
{
    ...
    public partial class BlockchainTx
    {
        public static BlockchainTx FromJson(string json) => JsonConvert.DeserializeObject<BlockchainTx>(json, Ark.ExternalUtilities.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this BlockchainTx self) => JsonConvert.SerializeObject(self, Ark.ExternalUtilities.Models.Converter.Settings);
    }
